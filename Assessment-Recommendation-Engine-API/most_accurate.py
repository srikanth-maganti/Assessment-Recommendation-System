...
Your task: From the provided list, **rank and return the top 1-10 most relevant assessments** for this job query based on the following parameters:
...
"""
    ...
    prompt += """
Now return the **top 1 to 10  most relavant assessments** in JSON list format like this:
